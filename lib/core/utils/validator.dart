...
/*class CardValidator {
  ...
  static String splitCardTypeName({String cardType}){

    var splitType = cardType.split(".");

    return splitType[1].toLowerCase();

  }

  static Widget getCardTypeIcon(BuildContext context, CardType cardType){
    ...
    if(cardType == null){
      ...
      if(image.isNotEmpty){
        widget = Image.asset("assets/images/payment_cards/$image", width: width(context) / 50,);
      }else{
        widget = icon;
      }
